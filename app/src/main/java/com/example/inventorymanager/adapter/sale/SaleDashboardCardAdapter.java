...
public class SaleDashboardCardAdapter extends RecyclerView.Adapter<SaleDashboardCardAdapter.ViewHolder>{
    ...
    public SaleDashboardCardAdapter(Activity activity, List<Card> cards) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SaleDashboardCardAdapter.ViewHolder holder, int position) {
...
//add your card item here
        ...
        SaleCardListAdapter listAdapter = new SaleCardListAdapter(cardList);
