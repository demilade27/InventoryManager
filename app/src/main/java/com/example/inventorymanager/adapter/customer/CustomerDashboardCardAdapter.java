...
public class CustomerDashboardCardAdapter extends RecyclerView.Adapter<CustomerDashboardCardAdapter.ViewHolder>{
    private Context activity;
    private List<Card>cards;

    public CustomerDashboardCardAdapter(Activity activity, List<Card> cards) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomerDashboardCardAdapter.ViewHolder holder, int position) {
